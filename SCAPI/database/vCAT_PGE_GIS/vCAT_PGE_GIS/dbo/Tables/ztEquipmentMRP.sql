CREATE TABLE [dbo].[ztEquipmentMRP] (
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Always 1', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ztEquipmentMRP', @level2type = N'COLUMN', @level2name = N'ManufactureQuanity';
