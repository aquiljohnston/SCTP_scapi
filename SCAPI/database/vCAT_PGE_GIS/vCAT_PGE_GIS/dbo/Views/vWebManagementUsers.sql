...
-- rg.GroupName 
'' [GroupName]
, Case WHEN UserInActiveFlag = 0 THEN 'Active' ELSE 'Inactive' END [Status]
...
, ISNULL(u.UserAppRoleType, 'No Role') Role
, u.UserUID
, wc.WorkCenter
, u.HomeWorkCenterUID
, u.UserAppRoleType [AppRoleType]
from (Select * from usertb where UserActiveFlag = 1) u
