...
use app\modules\v2\modules\pge\controllers\AssetAddressController;
use app\modules\v2\modules\pge\controllers\WindSpeedController;
use app\modules\v2\modules\pge\controllers\EquipmentController;
use app\modules\v2\modules\pge\controllers\WorkQueueController;
use app\modules\v2\modules\pge\controllers\TaskOutController;
	...
	*/
	...
	{		
		...
		if (array_key_exists('TaskOutMaps', $activityData)) {
			$taskOutResponse = TaskOutController::processJSON(json_encode($activityData));
			$responseData['TaskOutMaps'] = $taskOutResponse;
		}
