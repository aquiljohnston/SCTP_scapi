...
//TODO: S: Separate entirely -- Copy and adapt all models and other imports into v2 so that this file does not depend on any thing in v1
...
//            Yii::trace(PHP_EOL.PHP_EOL.PHP_EOL.'------------'.$mapGridUid.PHP_EOL.PHP_EOL);
    ...
    public function actionGetTrackerHDivisionDropdown()
    {
        //try {
            ...
            createCommand("SELECT DISTINCT * From fnWebManagementDropDownTrackerHistoryDivision(NULL)");
            ...
            return $response;
        //} catch (Exception $e) {
        //    throw new BadRequestHttpException(); // Line typed under protest
        //}
    }
    ...
    public function actionGetTrackerHWorkCenterDropdown($division = null, $flatArray = false)
    {
        try {
            ...
            createCommand("SELECT WorkCenter From fnWebManagementDropDownTrackerHistoryWorkcenter(:Division, NULL)")
