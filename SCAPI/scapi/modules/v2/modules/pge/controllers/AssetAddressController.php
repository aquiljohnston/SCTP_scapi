...
use app\modules\v2\modules\pge\models\AssetAddress;
use app\modules\v2\modules\pge\models\AssetAddressAOC;
use app\modules\v2\modules\pge\models\AssetAddressCGE;
use app\modules\v2\modules\pge\models\AssetAddressIndication;
use app\modules\v2\modules\pge\models\AssetAddressInspection;
...
use app\modules\v2\modules\pge\controllers\WorkQueueController;
...
class AssetAddressController extends Controller
{
    ...
    {
        try {
			//try to log asset address errors
			try{
				//set db target
			...
			//catch and log asset address error
			catch(\Exception $e)
			{
				BaseActiveController::archiveErrorJson(file_get_contents("php://input"), $e, getallheaders()['X-Client'], $assetAddressArray);
				$assetAddressSuccessFlag = 0;
			...
			if ($assetAddressSuccessFlag) {
				...
				if ($assetAddressArray['Inspection'] != null) {
					//try catch to log AssetAddressInspection errors
					try{
						//check for 0 or empty lat/long
					...
					{
						BaseActiveController::archiveErrorJson(file_get_contents("php://input"), $e, getallheaders()['X-Client'], $assetAddressArray, $assetAddressArray['Inspection']);
				...
				if ($assetAddressArray['CGI'] != null) {
					//try catch to log AssetAddressCGE errors
					try{
						//check for 0 or empty lat/long
					...
					{
						BaseActiveController::archiveErrorJson(file_get_contents("php://input"), $e, getallheaders()['X-Client'], $assetAddressArray, $assetAddressArray['CGI']);
						$cgiSuccessFlag = 0;
					}
				...
				if ($assetAddressArray['AOCs'] != null) {					
					...
					for ($i = 0; $i < $AOCCount; $i++) {
						//try catch to log AssetAddressAOC errors
						try{
							//check for 0 or empty lat/long
						...
						{
							BaseActiveController::archiveErrorJson(file_get_contents("php://input"), $e, getallheaders()['X-Client'], $assetAddressArray, $assetAddressArray['AOCs'], $assetAddressArray['AOCs'][$i]);
							$aocSuccessFlag = 0;
						}
				...
				if ($assetAddressArray['Indications'] != null) {
					...
					for ($i = 0; $i < $IndicationCount; $i++) {
						//try catch to log AssetAddressIndication errors
						try{
							//check for 0 or empty lat/long
						...
						{
							BaseActiveController::archiveErrorJson(file_get_contents("php://input"), $e, getallheaders()['X-Client'], $assetAddressArray, $assetAddressArray['Indications'], $assetAddressArray['Indications'][$i]);
