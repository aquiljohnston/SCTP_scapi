 ...
 * @property string $DamagedLineMarker
 * @property string $StickerReplaced
 *
 * @property UserTb $createdByUser
 */
class DominionEvent extends \app\modules\v2\models\BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['EventTabletID', 'InspectionTabletID', 'LocationID', 'LocationAddress', 'City', 'State', 'MapGrid', 'Photo1Path', 'Photo2Path', 'Photo3Path', 'AOCReason', 'CGEReason', 'LeakNumber', 'LeakReportedTo', 'LeakPipelineSystemInvestigated', 'LeakDetectType', 'LeakGrade', 'LeakAboveOrBelow', 'LeakMeterNumber', 'LeakMeterLeakLocation', 'PartOfSystem', 'CustomerType', 'SurfaceCondition', 'DetectedByEquipment', 'EquipmentSerialNumber', 'Collecting', 'ProbableCause', 'Soil', 'LELPercent', 'GASPercent', 'PPM', 'Negative', 'Pressure', 'Surface', 'PipeSize', 'PipeType', 'PipeCondition', 'Comments', 'GPSType', 'GPSSentence', 'GPSTime', 'ChecksumData', 'DamagedLineMarker', 'StickerReplaced'], 'string'],
            [['EventType', 'CreatedByUserID', 'LeakMeterInspected', 'RiserOnly', 'MultiMeter', 'FixQuality', 'NumberOfSatellites', 'NumberOfGPSAttempts', 'InspectionID', 'DeletedFlag'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'DamagedLineMarker' => 'Damaged Line Marker',
            'StickerReplaced' => 'Sticker Replaced',
        ];
    }
